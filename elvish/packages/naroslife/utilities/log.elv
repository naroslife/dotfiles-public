use github.com/kolbycrouch/elvish-libs/pure/list
use github.com/kolbycrouch/elvish-libs/pure/util
...
fn print-keybind {|keybind info|
  -print $keybind"\t"$info &color=yellow
}
